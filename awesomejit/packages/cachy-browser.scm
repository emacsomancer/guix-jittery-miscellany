...
;;; Copyright © 2023-2024 Ian Eure <ian@retrospec.tv>
;;; Copyright © 2023-2024 Benjamin Slade <slade@lambda-y.net>

(define-module (awesomejit packages cachy-browser)
...
;;  #:use-module (atomized packages icu4c)
  ...
  #:use-module (atomized packages wasm)
...
(define %cachy-build-id "20231218181400")

(define-public cachy-browser
  (package
    (name "cachy-browser")
    (version "122.0.1-1")
    (source
     (origin
       (method url-fetch)
;; multiple sources: https://aur.archlinux.org/cgit/aur.git/tree/PKGBUILD?h=cachy-browser
       (uri (string-append
             "https://gitlab.com/api/v4/projects/32320088/packages/generic/librewolf-source/"
             version "/librewolf-" version ".source.tar.gz"))
       (sha256
        (base32 "0w0dhf3lvg2xvsnhdwfw995by8sxbl70r9gddqiqbjgfclq1i497"))))
                       ...
                       (let* ((desktop-file
                         ...
                         (substitute* desktop-file
                           ...
                           (("^Name\\[(ar|bn)\\].*$")
                            "")
                           (("^Icon=.*")
                            (string-append "Icon=" #$output "/share/icons/hicolor/128x128/apps/librewolf.png\n"))
